...
<body>
                            ...
                            <div class="col-lg-5 col-md-6 no-padding">
                                <div class="register_container">
                                    <form id="register-form" class="form-signin" method="POST">
                                        <div class="login-box">
                                            <h5><span class="text_1_login">Welcome Back <img src="./images/logo.svg" style="width: 20px;"></span></h5>
                                            ...
                                            <div class="login-row donroo row no-margin">
                                                <a class="btn btn-warning btn-sm" href="php/logout.php" id="Logout" role="button" onclick="localStorage.clear();">Logout</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    <?php
        ...
        echo '<div class="text-center"><a class="btn btn-primary btn-lg" href="php/index.php" role="button">Back To Home</a></div>';
    }
    ?>
</body>
<script>
